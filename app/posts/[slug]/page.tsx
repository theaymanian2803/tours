...
<>
    ...
    <Image src={post.mainImage} alt={post.slug} layout="fill" className="w-full h-full object-cover " />
    ...
    <div className="h-screen flex w-full justify-center bg-gray-200 relative p-9">
      <div className=" bg-slate-400 h-9 absolute top=10">
      </div>
      <Image src={post.mainImage} height={300} width={300} alt="image"
       className="h-96"/>
    </div>
    </>
  )
