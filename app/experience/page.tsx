...
const Experience = () => {
  ...
  const y = useTransform(scrollYProgress, [0.6, 1], [0, height * 0.1]);
  const y1 = useTransform(scrollYProgress, [0.5, 1], [0, height * 0.8]);
  const y2 = useTransform(scrollYProgress, [0.6, 1], [0, height * 1]);
  const y3 = useTransform(scrollYProgress, [0.5, 1], [0, height * 0.8]);
  ...
  return (
    <>
      ...
      <div
        className=" h-screen relative top-[-100px] mx-auto overflow-hidden w-full grid items-center justify-center md:grid-cols-4 gap-8"
        ref={container}>
        <Column
            ...
            <div className="hero-content flex-col lg:flex-row">
              ...
              <div className=" flex flex-col gap-8">
                ...
                <p>
                  ...
                  Chebbi luxury desert camping. Tents are equipped with: Bathtub
                  jacuzzi A/C hot or cold working at night Private bathroom with
                  flush toilet/ sink/ shower – hot and cold water Towels and set
                  of toiletries Electricity Water and seasonal fruit
                </p>
          ...
          <>
            <div key={Math.random().toFixed(2) + 1}>
              <Image
                ...
                height={500}
                alt="img"
                className="md:w-full h-[400px] object-cover border-8 border-orange-400/50"
              />
            </div>
          </>
        );
