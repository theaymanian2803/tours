...
function Statistic() {
  return (
    <div>
      <div className="flex flex-col justify-center items-center h-[60vh] pt-4 dark:text-black">
        <div className="min-w-[375px] md:min-w-[700px] xl:min-w-[800px] mt-3 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-3 3xl:grid-cols-6">
              ...
              <div className="rounded-full bg-lightPrimary p-3 dark:bg-navy-700">
                <span className="flex items-center text-brand-500 dark:text-white">
                  <svg
                    ...
                    stroke-width="0"
                    viewBox="0 0 24 24"
                    className="h-7 w-7 dark:text-black"
                    height="1em"
                    width="1em"
          ...
          <div className="relative flex flex-grow flex-row f items-center rounded-[10px]  border-[1px] border-gray-200 bg-white bg-clip-border shadow-md shadow-[#F3F3F3] dark:border-[#ffffff33] dark:!bg-navy-800 dark:text-white dark:shadow-none">
            <div className="ml-[18px] flex h-[90px] w-auto flex-row items-center">
              <div className="rounded-full bg-lightPrimary p-3 dark:bg-navy-700">
                <span className="flex items-center text-brand-500 dark:text-white">
                  <svg
        ...
        <p className="font-normal text-navy-700 mt-20 mx-auto w-max dark:text-white">
